...
- [**Using the Nirdisto Starter**](#option-1-using-the-nirdisto-starter) - Easy to upgrade, isolates irrelevant project files so you can focus on writing.
...
#### Option 1. Using the Nirdisto Starter

Create a new repository from the [**Nirdisto Starter**][use-starter] and name it `<GH_USERNAME>.github.io`, where `GH_USERNAME` represents your GitHub username.

#### Option 2. Forking on GitHub

[Fork **Nirdisto**](https://github.com/md-palash-hossain/jekyll-theme-nirdisto/fork) on GitHub and rename it to `<GH_USERNAME>.github.io`. Please note that the default branch code is in development.  If you want the site to be stable, please switch to the [latest tag][latest-tag] and start writing.
...
Starting from [`v4.1.0`][nirdisto-4.1.0], if you want to overwrite the SASS variables defined in `_sass/addon/variables.scss`{: .filepath}, create a new file `_sass/variables-hook.scss`{: .filepath} and assign new values to the target variable in it.
...
Also, if you'd like to self-host the static assets, please refer to the [_nirdisto-static-assets_](https://github.com/md-palash-hossain/nirdisto-static-assets#readme).
...
- If you are using the theme gem (there will be `gem "jekyll-theme-nirdisto"` in the `Gemfile`{: .filepath}), editing the `Gemfile`{: .filepath} and update the version number of the theme gem, for example:

  ```diff
  - gem "jekyll-theme-nirdisto", "~> 3.2", ">= 3.2.1"
  + gem "jekyll-theme-nirdisto", "~> 3.3", ">= 3.3.0"
  ```
...
[starter]: https://github.com/md-palash-hossain/nirdisto-starter
[use-starter]: https://github.com/md-palash-hossain/nirdisto-starter/generate
[workflow]: https://github.com/md-palash-hossain/jekyll-theme-nirdisto/blob/master/.github/workflows/pages-deploy.yml.hook
[nirdisto-4.1.0]: https://github.com/md-palash-hossain/jekyll-theme-nirdisto/releases/tag/v4.1.0
[pages-workflow-src]: https://docs.github.com/en/pages/getting-started-with-github-pages/configuring-a-publishing-source-for-your-github-pages-site#publishing-with-a-custom-github-actions-workflow
[latest-tag]: https://github.com/md-palash-hossain/jekyll-theme-nirdisto/tags
